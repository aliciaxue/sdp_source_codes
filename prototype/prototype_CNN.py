...
processed_inputs = Reshape((30, 84, 1))(inputs)
processed_inputs = Convolution2D(30, (3, 3), padding='valid', activation='selu')(processed_inputs)
processed_inputs = Convolution2D(8, (3, 3), padding='valid', activation='selu')(processed_inputs)
processed_inputs = AveragePooling2D(pool_size = (3, 3), strides = None, padding = 'valid')(processed_inputs)
processed_inputs = Flatten()(processed_inputs)
processed_inputs = Dense(120, activation='selu')(processed_inputs)
processed_inputs = Dropout(0.2)(processed_inputs)
predictions = Dense(4, activation = 'softmax')(processed_inputs)
